...
Image_for_Normalization=dir('D:\uB\Applied Mathematics\Face Recognition Math Project\Final PCA Project Md Kamrul Hasan\Image and data To be Normalized for Training\*.jpg'); 
% 5 Predefined Features (All should be .txt file) Read from the directory for Normalization
Image_5_Features=dir('D:\uB\Applied Mathematics\Face Recognition Math Project\Final PCA Project Md Kamrul Hasan\Image and data To be Normalized for Training\*.txt');
%% Initial Pre-Processing of the Image and selected Features
for Iteration = 1:length(Image_for_Normalization) 
Set_Image_Title_for_Read = ['Image and data To be Normalized for Training\' Image_for_Normalization(Iteration).name];
Set_Text_Tile_for_Feature = ['Image and data To be Normalized for Training\' Image_5_Features(Iteration).name]; 
...
for Iteration_2 = 1:length(Image_for_Normalization)
    ...
    Set_Image_Title_for_Read = ['Training Image After Normalization\' Image_for_Normalization(Iteration_2).name];
